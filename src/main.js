...
var CDN_ROOT = typeof __box !== 'undefined' ? __box.CDN || '' : '',
    requireBox = requirejs.config({
        enforceDefine: false,
        baseUrl: CDN_ROOT + "/js/",
        map: {
            '*': {
                'css': CDN_ROOT + '/vendor/require-css/css.js'
            }
        },
        paths: {
            app: CDN_ROOT + "/js/",
            ...
            'jquery-ui': CDN_ROOT + '/vendor/jquery-ui/jquery-ui.min',
            TraceKit: CDN_ROOT + '/js/tracekit',
            select2: CDN_ROOT + '/vendor/select2/js/select2.full.min',
            'select2-ro': CDN_ROOT + '/vendor/select2/js/i18n/ro',
            moment: CDN_ROOT + "/vendor/moment/moment.min",
            'moment-locale': CDN_ROOT + "/vendor/moment/moment-with-locales.min",
            summernote: CDN_ROOT + '/vendor/summernote/summernote',
            lodash: CDN_ROOT + '/vendor/lodash/lodash.min',
            Flow: CDN_ROOT + '/vendor/flow.js/flow',
            Navigo: CDN_ROOT + '/vendor/navigo/navigo',
            bootstrap: CDN_ROOT + "/vendor/bootstrap/js/bootstrap.min",
            'bootstrap-datetimepiker': CDN_ROOT + '/vendor/eonasdan-bootstrap-datetimepicker/bootstrap-datetimepicker.min',
            'datatables.net': CDN_ROOT + '/vendor/datatables/jquery.dataTables.min',
            'datatables.net-bs': CDN_ROOT + '/vendor/datatables/dataTables.bootstrap.min',
            'datatables.net-responsive': CDN_ROOT + '/js/dataTables.responsive',
            dataTablesResponsiveBoostrap: CDN_ROOT + '/vendor/datatables-responsive/responsive.bootstrap',
            'datatables.net-buttons': CDN_ROOT + '/vendor/datatables.net-buttons/dataTables.buttons',
            'datatables.buttons.colVis': CDN_ROOT + '/vendor/datatables.net-buttons/buttons.colVis',
            'datatables.buttons.flash': CDN_ROOT + '/vendor/datatables.net-buttons/buttons.flash',
            'datatables.buttons.html5': CDN_ROOT + '/vendor/datatables.net-buttons/buttons.html5',
            'datatables.buttons.print': CDN_ROOT + '/vendor/datatables.net-buttons/buttons.print',
            'datatables.net-buttons-bs': CDN_ROOT + '/vendor/datatables.net-buttons-bs/buttons.bootstrap',
            dust: CDN_ROOT + '/vendor/dustjs-linkedin/dust-full',
            'dust.core': CDN_ROOT + '/vendor/dustjs-linkedin/dust-core',
            'dust-helpers': CDN_ROOT + '/vendor/dustjs-helpers/dust-helpers.min',
            'socket-io': CDN_ROOT + '/vendor/socket.io-client/socket.io',
            WebFont: CDN_ROOT + '/vendor/bower-webfontloader/webfont',
            'qrcode.js': CDN_ROOT + '/vendor/qrcode.js/qrcode',
            ace: CDN_ROOT + '/vendor/ace-builds/src-noconflict/ace',
            'snap.svg': CDN_ROOT + '/vendor/snap.svg/snap.svg-min',
            photoswipe: CDN_ROOT + '/vendor/photoswipe/photoswipe',
            'photoswipe-ui': CDN_ROOT + '/vendor/photoswipe/photoswipe-ui-default',
            'fusty-factory': CDN_ROOT + '/vendor/fusty-flow.js/fusty-flow-factory',
            'fusty-flow': CDN_ROOT + '/vendor/fusty-flow.js/fusty-flow',
            easypiechart: CDN_ROOT + '/vendor/jquery.easy-pie-chart/jquery.easypiechart',
            chartjs: CDN_ROOT + '/vendor/chart.js/Chart',
            sparkline: CDN_ROOT + '/vendor/sparkline/jquery.sparkline',
            flot: CDN_ROOT + '/vendor/Flot/jquery.flot',
            Raphael: CDN_ROOT + '/vendor/raphael/raphael.min',
            morris: CDN_ROOT + '/vendor/morris.js/morris',
            spectrum: CDN_ROOT + '/vendor/spectrum/spectrum',
            pivot: CDN_ROOT + '/vendor/pivottable/pivot',
            d3_renderers: CDN_ROOT + '/vendor/pivottable/d3_renderers',
            c3_renderers: CDN_ROOT + '/vendor/pivottable/c3_renderers',
            export_renderers: CDN_ROOT + '/vendor/pivottable/export_renderers',
        ...
        "shim": {
            ...
            select2: {
                deps: ['jQuery',
                    'css!' + CDN_ROOT + '/vendor/select2/css/select2.min.css',
                    'css!' + CDN_ROOT + '/vendor/select2-bootstrap-theme/select2-bootstrap.min.css'],
                exports: '$.fn.select2'
            },
            'select2-ro': {
                deps: ['select2']
            ...
            'datatables.net-responsive': {
                deps: ['datatables.net'],
                exports: '$.fn.DataTable.Responsive'
            },
            dataTablesResponsiveBoostrap: {
                deps: ['datatables.net-bs',
                    'datatables.net-responsive',
                    'css!' + CDN_ROOT + '/vendor/datatables/jquery.dataTables',
                    'css!' + CDN_ROOT + '/vendor/datatables/dataTables.bootstrap',
                    'css!' + CDN_ROOT + '/vendor/datatables-responsive/responsive.bootstrap']
            },
            'datatables.net-bs': {
                deps: ['datatables.net']
            },
            ...
            blockly: { exports: 'Blockly' },
            blockly_blocks: {
                deps: ['blockly'],
                exports: 'Blockly.Blocks.colour'
            },
            blockly_msgs: {
                deps: ['blockly_blocks']
            }
...
define('Box', ['api', 'TraceKit', 'jQuery', 'lodash', 'require'],
    function (api, TraceKit, $, _, require) {
        ...
        TraceKit.remoteFetching = !CDN_ROOT;
...
if (typeof __box !== 'undefined' && typeof __box.ignite === 'function') {
    requireBox(['Box'], function (Box) {
        return __box.ignite(Box);
    });
}

if (typeof document.querySelector === 'function') {
    var dsc = document.querySelector('script[data-bootstrap][data-main]') &&
        document.querySelector('script[data-bootstrap][data-main]').getAttribute('data-bootstrap');

    if (dsc) {
        requireBox([dsc], function (d) {
            if (d && typeof d.ignite === 'function') {
                d.ignite();
            }
        });
    }
